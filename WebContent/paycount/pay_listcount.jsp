          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1">工资统计列表</span></td>
              </tr>
            </table></td>
            <td><div align="right">
            	<span class="STYLE1">
              ...
              <a href="toPay_Add.do" class="common_a"><img src="images/add.gif" width="10" height="10" /> 添加 </a>-->  
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <!-- 
  ...
  <tr>
    ...
    <table width="100%"   border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="12%" height="30" align="right" class="STYLE19">姓名：</td>
        <td width="12%" class="STYLE19"><input name="name" type="text" id="name" size="15" /></td>
        <td width="9%" align="right" class="STYLE19">部门：</td>
        <td width="13%" class="STYLE19">
        	 <input name="dep" type="text" id="dep" size="15" />
        </td>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" >
      <tr>
        ...
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">基本工资</span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">四险</span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">住房公积金</span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">加班金额</span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">应发工资</span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">实发工资</span></div></td>
        <td width="" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">基本操作</span></div></td>
      </tr>
      
      <s:iterator value="#request.payInfoList" id="info" status="status">
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE19">${info.name}</span></div></td>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${info.fourx}</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${info.zhufang}</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${info.otmoney}</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${info.shouldgive}</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${info.reallygive}</div></td>
   ...
   <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" >
  	 <tr>
  	 	<td height="20" width="4%" bgcolor="#FFFFFF" class="STYLE19"><div align="center">&nbsp;</div></td>
  	 	<td height="20" width="3%" bgcolor="#FFFFFF" class="STYLE19"><div align="center">&nbsp;</div></td>
  	 	<td height="20" width="10%" bgcolor="#FFFFFF" class="STYLE19"><div align="center">&nbsp;</div></td>
  	 	<td height="20" width="10%" bgcolor="#FFFFFF" class="STYLE19"><div align="center">&nbsp;</div></td>
  	 	<td height="20" width="10%" bgcolor="#FFFFFF" class="STYLE19"><div align="center">&nbsp;</div></td>
  	 	<td height="20" width="10%" bgcolor="#FFFFFF" class="STYLE19"><div align="center">&nbsp;</div></td>
  	 	<td height="20" width="10%" bgcolor="#FFFFFF" class="STYLE19"><div align="center">&nbsp;</div></td>
  	 	<td height="20" width="10%" bgcolor="#FFFFFF" class="STYLE19"><div align="center">&nbsp;</div></td>
  	 	<td height="20" width="10%" bgcolor="#FFFFFF" class="STYLE19"><div align="center">工资总支出：</div></td>
  	 	<td height="20" width="10%" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${request.paysum}</div></td>
  	 	<td height="20" width="" bgcolor="#FFFFFF" class="STYLE19"><div align="center">&nbsp;</div></td>
  	 </tr>
  </table> 	   
...
function query(){
    ...
    queryForm.action="${pageContext.request.contextPath}/queryPayInfosCount.do";
	queryForm.submit();
}
...
function page(page){
	var pageUrl="${pageContext.request.contextPath}/queryPayInfosCount.do";
		pageUrl+="?"+paramUrl;
	if(page=='pageTo'){
	...
	if(flag=="n"){
		...
		if(num==0){
			...
			if(window.confirm("数据删除后不可恢复，确定要删除吗?")){						
				var url = '${pageContext.request.contextPath}/Delete_PayInfo.do';
...
function viewRecord(id){
	window.location.href = "${pageContext.request.contextPath}/toView_PayInfoCount.do?id="+id+"";
}

//编辑“工资” 的信息 			
function editRecord(id){
	window.location.href = "${pageContext.request.contextPath}/toEdit_PayInfo.do?id="+id+"";
}
</script>	
