          ...
          <tr>
            <td width="56%"><table width="91%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="96%" valign="bottom"><span class="style_navi">修改用户</span></td>
              </tr>
            </table></td>
    ...
    <table width="100%"  border="0" cellpadding="0" cellspacing="1"  bgcolor="#a8c7ce">
        ...
        <tr>
          ...
          <td height="25" width="59%" bgcolor="#FFFFFF" class="style_td">
          	<input type="text" name="username" id="username" size="25" value="${request.EditUserinfo.username}" readonly="readonly" style="background-color: #ADADAD"/><font class="mustWrite">*</font>
          	<input type="hidden" id="id" name="id" value="${request.EditUserinfo.id}"/>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td height="25" bgcolor="#FFFFFF" class="style_td">
          	<select id="roleid" name="roleid" >
				...
				<option value="1" <s:if test="#request.EditUserinfo.roleid==1">selected="selected"</s:if>>管理员</option>
				<option value="2" <s:if test="#request.EditUserinfo.roleid==2">selected="selected"</s:if>>员工</option>
        ...
        <tr>
          ...
          <td height="25" width="59%" bgcolor="#FFFFFF" class="style_td">
          	<input type="text" name="truename" id="truename" size="25" value="${request.EditUserinfo.truename}"/>
          </td>
        </tr>
         ...
         <tr>
          ...
          <td height="25" width="59%" bgcolor="#FFFFFF" class="style_td">
          	<input type="text" name="phone" id="phone" size="25" value="${request.EditUserinfo.phone}"/>
          </td>
         </tr>
         ...
         <tr>
          ...
          <td height="25" width="59%" bgcolor="#FFFFFF" class="style_td">
          	<input type="text" name="address" id="address" size="25" value="${request.EditUserinfo.address}"/>
          </td>
         </tr>
         ...
         <tr>
          ...
          <td height="25" width="59%" bgcolor="#FFFFFF" class="style_td">
          	<input type="text" name="age" id="age" size="25" value="${request.EditUserinfo.age}"/>
          </td>
         </tr>
        ...
        <tr>
          ...
          <td height="25" bgcolor="#FFFFFF" class="style_td">
          	<select id="sex" name="sex" >
				...
				<option value="1" <s:if test="#request.EditUserinfo.sex==1">selected="selected"</s:if>>男</option>
				<option value="2" <s:if test="#request.EditUserinfo.sex==2">selected="selected"</s:if>>女</option>
			</select><font class="mustWrite">*</font>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td height="25" width="59%" bgcolor="#FFFFFF" class="style_td">
          	<input type="text" name="dep" id="dep" size="25" value="${request.EditUserinfo.dep}"/>
          </td>
         </tr>
         ...
         <tr>
          ...
          <td height="25" bgcolor="#FFFFFF" class="style_td">
          	<select id="degree" name="degree" >
				...
				<option value="1" <s:if test="#request.EditUserinfo.degree==1">selected="selected"</s:if>>初中</option>
				<option value="2" <s:if test="#request.EditUserinfo.degree==2">selected="selected"</s:if>>高中</option>
				<option value="3" <s:if test="#request.EditUserinfo.degree==3">selected="selected"</s:if>>中专</option>
				<option value="4" <s:if test="#request.EditUserinfo.degree==4">selected="selected"</s:if>>本科</option>
				<option value="5" <s:if test="#request.EditUserinfo.degree==5">selected="selected"</s:if>>研究生</option>
			</select> 
          </td>
        </tr> 
        ...
        <tr>
          ...
          <td height="25" bgcolor="#FFFFFF" class="style_td">
          	<select id="mianmao" name="mianmao" >
				...
				<option value="1" <s:if test="#request.EditUserinfo.mianmao==1">selected="selected"</s:if>>中共党员</option>
				<option value="2" <s:if test="#request.EditUserinfo.mianmao==2">selected="selected"</s:if>>中共预备党员</option>
				<option value="3" <s:if test="#request.EditUserinfo.mianmao==3">selected="selected"</s:if>>共青团员</option>
				<option value="4" <s:if test="#request.EditUserinfo.mianmao==4">selected="selected"</s:if>>民盟盟员</option>
			</select> 
          </td>
        </tr>
        ...
        <tr>
          ...
          <td height="25" width="59%" bgcolor="#FFFFFF" class="style_td">
          	<input type="text" name="job" id="job" size="25" value="${request.EditUserinfo.job}"/>
          </td>
         </tr> 
         ...
         <tr>
          ...
          <td height="25" width="59%" bgcolor="#FFFFFF" class="style_td">
          	<input type="text" name="idno" id="idno" size="25" value="${request.EditUserinfo.idno}"/>
          </td>
         </tr>
         ...
         <tr>
          ...
          <td height="25" width="59%" bgcolor="#FFFFFF" class="style_td">
          	<input type="text" name="email" id="email" size="25" value="${request.EditUserinfo.email}"/>
          </td>
         </tr>
         ...
         <tr>
			...
			<input type="hidden" name="pic_url" id="pic_url" value="${request.EditUserinfo.pic }" />
...
function callbackEditUserInfo(data){
	if(data.success){
	  alert("用户信息修改成功！");
 	  window.location.href="${pageContext.request.contextPath}/queryUserInfos.do";
    }else{
   		alert("用户信息修改失败,请与管理员联系");
    }
}
