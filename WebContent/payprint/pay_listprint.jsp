          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1">工资报表统计</span></td>
              </tr>
            </table></td>
            <td><div align="right">
            	<span class="STYLE1">
  ...
  <tr>
    ...
    <table width="100%"   border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="12%" class="STYLE19"><input name="name" type="text" id="name" size="15" value="${requestScope.payInfo.name }"/></td>
        <td width="9%" align="right" class="STYLE19">部门：</td>
        <td width="13%" class="STYLE19">
        	 <input name="dep" type="text" id="dep" size="15" value="${requestScope.payInfo.dep }"/>
        </td>
        <td width="8%"><input type="button"  class="btn"   value="查询" onclick="query()"/></td>
        ...
        <td width="">
          <table width="88%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td class="STYLE1">
              <div align="center">
              <a href="#" onclick="toExport()">
              <img src="${pageContext.request.contextPath}/images/export1.jpg" width="14" height="14" border="0" />&nbsp;下载Excel报表
              </a>
...
function toExport(){
  ...
  var url = "${pageContext.request.contextPath}/paymanage/downloadExcel/downloadExcel.do?fileName=payInfo";
      url+= "&&name="+encodeURI(encodeURI(name))+"";
      url+= "&&dep="+encodeURI(encodeURI(dep))+"";
...
function query(){
    ...
    queryForm.action="${pageContext.request.contextPath}/queryPayInfosPrint.do";
	queryForm.submit();
}
...
/**
  *分页跳转
*/
var paramUrl="&&name=${requestScope.payInfo.name}";
	paramUrl+="&&dep=${requestScope.payInfo.dep}";
...
function page(page){
	var pageUrl="${pageContext.request.contextPath}/queryPayInfosPrint.do";
		pageUrl+="?"+paramUrl;
	if(page=='pageTo'){
