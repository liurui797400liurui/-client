          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1">奖惩信息列表</span></td>
              </tr>
            </table></td>
            <td><div align="right">
            	<span class="STYLE1">
              ...
              <a href="toReward_Add.do" class="common_a"><img src="images/add.gif" width="10" height="10" /> 添加 </a> &nbsp;
              <!-- 
  ...
  <tr>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" >
      <tr>
        ...
        <td width="" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">姓名</span></div></td>
        <td width="" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">部门</span></div></td>
        <td width="" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">奖惩类型</span></div></td>
        <td width="" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">请假类型</span></div></td>
        <td width="" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">请假天数</span></div></td>
        <td width="" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">加班天数</span></div></td>
        <td width="" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">金额</span></div></td>
        <td width="20%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">基本操作</span></div></td>
      </tr>
      
      <s:iterator value="#request.rewardInfoList" id="info" status="status">
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">
        	  <s:if test="#request.info.type==1">请假</s:if>
        	  <s:if test="#request.info.type==2">加班</s:if>
        </div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">
        		<s:if test="#request.info.leavetype==-1">无请假</s:if>
        		<s:if test="#request.info.leavetype==1">病假</s:if>
        	    <s:if test="#request.info.leavetype==2">事假</s:if>
        		<s:if test="#request.info.leavetype==3">其他</s:if>
        </div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${info.leaveday}</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${info.otday}</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${info.money}</div></td>
        
        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21"> 
        <a onclick="editRecord('${info.id}')" class="common_a"> 编辑 </a>| 
        <a class="common_a" onclick="viewRecord('${info.id}')">查看</a> | 
        <a class="common_a" onclick="deleteRecord('${info.id}')">删除 </a>
        </div></td>
      </tr>
      </s:iterator>
...
function query(){
    ...
    queryForm.action="${pageContext.request.contextPath}/queryRewardInfos.do";
	queryForm.submit();
}
...
function page(page){
	var pageUrl="${pageContext.request.contextPath}/queryRewardInfos.do";
		pageUrl+="?"+paramUrl;
	if(page=='pageTo'){
	...
	if(flag=="n"){
		...
		if(num==0){
			...
			if(window.confirm("数据删除后不可恢复，确定要删除吗?")){						
				var url = '${pageContext.request.contextPath}/Delete_RewardInfo.do';
...
function viewRecord(id){
	window.location.href = "${pageContext.request.contextPath}/toView_RewardInfo.do?id="+id+"";
}

//编辑“奖惩” 的信息 			
function editRecord(id){
	window.location.href = "${pageContext.request.contextPath}/toEdit_RewardInfo.do?id="+id+"";
}
</script>	
