    ...
    <table width="100%"  border="0" cellpadding="0" cellspacing="1"  bgcolor="#a8c7ce">
        ...
        <tr>
          ...
          <td height="25" width="25%" bgcolor="#FFFFFF" class="style_td">
          	<div align="center">${ViewPayInfoP.name}</div>
          </td>
