          ...
          <tr>
            <td width="56%"><table width="91%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="96%" valign="bottom"><span class="style_navi">工资录入</span></td>
              </tr>
            </table></td>
   ...
   <td>
    <table width="100%"  border="0" cellpadding="0" cellspacing="1"  bgcolor="#a8c7ce">
        ...
        <tr>
          ...
          <td height="25" bgcolor="#FFFFFF" class="style_td">
          	 <input type="text" id="basepay" name="basepay" value="0" size="30" maxlength="18" 
        ...
        <tr>
          ...
          <td height="25" bgcolor="#FFFFFF" class="style_td">
          	 <input type="text" id="jixiaopay" name="jixiaopay" value="0" size="30" maxlength="18" 
          	 onkeyup="this.value=this.value.replace(/[^\d\.]+?/g,'')" onblur="calsixian()"/> 
          	 绩效工资 =  为奖惩中的加班金额
          </td>
        </tr>
        ...
        <tr>
          ...
          <td height="25" bgcolor="#FFFFFF" class="style_td">
          	 <input type="text" id="traffic" name="traffic" value="0" size="30" maxlength="18" 
          	 onkeyup="this.value=this.value.replace(/[^\d\.]+?/g,'')" onblur="calsixian()" /> 
          </td>
        </tr>
        ...
        <tr>
          ...
          <td height="25" bgcolor="#FFFFFF" class="style_td">
          	 <input type="text" id="communi" name="communi" value="0" size="30" maxlength="18" 
          	 onkeyup="this.value=this.value.replace(/[^\d\.]+?/g,'')" onblur="calsixian()" /> 
          </td>
        </tr>
         ...
         <tr>
          ...
          <td height="25" bgcolor="#FFFFFF" class="style_td">
          	 <input type="text" id="mealallow" name="mealallow" value="0" size="30" maxlength="18" 
          	 onkeyup="this.value=this.value.replace(/[^\d\.]+?/g,'')" onblur="calsixian()" /> 
          </td>
        </tr>
         ...
         <tr>
          ...
          <td height="25" bgcolor="#FFFFFF" class="style_td">
          	 <input type="text" id="otmoney" name="otmoney" value="0" size="30" maxlength="18" 
          	 onkeyup="this.value=this.value.replace(/[^\d\.]+?/g,'')" onblur="calsixian()" /> 
          </td>
        </tr>
         ...
         <tr>
          ...
          <td height="25" bgcolor="#FFFFFF" class="style_td">
          	 <input type="text" id="award" name="award" value="0" size="30" maxlength="18" 
          	 onkeyup="this.value=this.value.replace(/[^\d\.]+?/g,'')" onblur="calsixian()" /> 
          </td>
        </tr>
         ...
         <tr>
          ...
          <td height="25" bgcolor="#FFFFFF" class="style_td">
          	 <input type="text" id="fourx" name="fourx" value="0" size="30" maxlength="18" 
        ...
        <tr>
          ...
          <td height="25" bgcolor="#FFFFFF" class="style_td">
          	 <input type="text" id="zhufang" name="zhufang" value="0" size="30" maxlength="18" 
          	 onkeyup="this.value=this.value.replace(/[^\d\.]+?/g,'')" style="background: #CCCCCC"  /> 
          	 住房公积金 = 基本工资 * 8% 
          </td>
        </tr>
         ...
         <tr>
          ...
          <td height="25" bgcolor="#FFFFFF" class="style_td">
          	 <input type="text" id="attendsub" name="attendsub" value="0" size="30" maxlength="18" 
         ...
         <tr>
          ...
          <td height="25" bgcolor="#FFFFFF" class="style_td">
          	 <input type="text" id="shouldgive" name="shouldgive" value="0" size="30" maxlength="18" 
          	 onkeyup="this.value=this.value.replace(/[^\d\.]+?/g,'')" style="background: #CCCCCC"  /> 
          	 <br/>
        ...
        <tr>
          ...
          <td height="25" bgcolor="#FFFFFF" class="style_td">
          	 <input type="text" id="tax" name="tax" value="0" size="30" maxlength="18" 
          	 onkeyup="this.value=this.value.replace(/[^\d\.]+?/g,'')" style="background: #CCCCCC"  /> 
          </td>
        </tr>
         ...
         <tr>
          ...
          <td height="25" bgcolor="#FFFFFF" class="style_td">
          	 <input type="text" id="reallygive" name="reallygive" value="0" size="30" maxlength="18" 
          	 onkeyup="this.value=this.value.replace(/[^\d\.]+?/g,'')" style="background: #CCCCCC"  /> 
          	 实发工资 = 应发工资 - 个人所得税
          </td>
        </tr>
...
function callbackgetUserPayInfo(data){
        if(data.success){
        	if(data.dep == null){ 
        		...
        		$("#dep").val( data.dep ); 
        		//同时还需要把绩效工资 和 考勤扣除额 查询出来 
        		// 绩效工资 = 加班金额
        		$("#jixiaopay").val( data.otmoney ); 
        		
        		//考勤扣除额 = 请假类型的金额
        		$("#attendsub").val( data.attendsub ); 
...
function addPayinfo(){
     ...
     jQuery.post(url, params, callbackAddPayInfo, 'json');
}
/**
*异步添加的回调函数
*/ 
function callbackAddPayInfo(data){
        if(data.success){
			alert("工资信息录入成功！");
		 	window.location.href="${pageContext.request.contextPath}/toPay_Add.do";
        }else{
       		alert("工资信息录入失败,请与管理员联系");
        }
}
