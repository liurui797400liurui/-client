          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1">工资信息列表</span></td>
              </tr>
            </table></td>
            <td><div align="right">
            	<span class="STYLE1">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" >
      <tr>
        ...
        <td width="" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">基本工资</span></div></td>
        <td width="" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">四险</span></div></td>
        <td width="" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">住房公积金</span></div></td>
        <td width="" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">加班金额</span></div></td>
        <td width="" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">应发工资</span></div></td>
        <td width="" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">实发工资</span></div></td>
...
function query(){
    ...
    queryForm.action="${pageContext.request.contextPath}/queryPayInfos.do";
	queryForm.submit();
}
...
function page(page){
	var pageUrl="${pageContext.request.contextPath}/queryPayInfos.do";
		pageUrl+="?"+paramUrl;
	if(page=='pageTo'){
...
function viewRecord(id){
	window.location.href = "${pageContext.request.contextPath}/toView_PayInfo.do?id="+id+"";
}
